...
public class SuperAdminVisitFeedbackServiceImpl implements SuperAdminVisitFeedbackService {
  ...
  public VisitFeedbackDto get(Integer id) {
    return visitFeedbackMapper.visitFeedbackToVisitFeedbackDto(visitFeedbackRepository.findById(id).orElseThrow(
